                                            ...
                                            function(authResult) {
                                                if (authResult) {
                                                    gapi.client.load('calendar', 'v3', function() {
                                                        ...
                                                        request.execute(function(inner) {
                                                            if (inner.items) {
                                                                w = 203 * inner.items.length;
                                                            }
                                                            me.setSize(w,h);
                                                            surface.setSize(w,h);
                                                            ...
                                                            if (inner.items) {
                                                                for (var iter = 0; iter < inner.items.length; iter++) {
                                                                    xloc = iter*200;
                                                                    ...
                                                                    if (iter % 2 === 0) {
                                                                        ...
                                                                        surface.add({
                                                                            type: 'text',
                                                                            text: inner.items[iter].start.datetime,
                                                                            font: '14px Arial',
                                                                            fill: '#FFF',
                                                                            x: 170,
                                                                            y: 380
